...
public class Lab8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RightPanel.setPreferredSize(new java.awt.Dimension(548, 700));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(RightPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 477, Short.MAX_VALUE))
        );
    ...
    private void Option1PanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Option1PanelMouseClicked
        ...
        for (int i = 0; i < 5; i++){
            ...
            separator.setPreferredSize(new Dimension(460, 10));
            JLabel label = new JLabel("I am label " + i);
            JPanel user = new JPanel();
            user.setBackground(Color.WHITE);
            user.setLayout(new BorderLayout());
            user.setPreferredSize(new Dimension(480, 30));
            JLabel username = new JLabel("   This is label " + i);
